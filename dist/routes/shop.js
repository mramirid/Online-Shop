...
router.get('/checkout', is_auth_1.default, shopController.getCheckout);
router.get('/checkout/success', is_auth_1.default, shopController.getCheckoutSuccess);
router.get('/checkout/cancel', is_auth_1.default, shopController.getCheckout);
